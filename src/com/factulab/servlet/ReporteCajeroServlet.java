...
/**
 * Servlet implementation class CargarReporteCajeroServlet
 */
public class ReporteCajeroServlet extends HttpServlet {
	Logger miLog = Logger.getLogger(ReporteCajeroServlet.class);
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(txt_accion.equals("repAteFact")){
	            ...
	            reporte = getServletContext().getRealPath("WEB-INF") + "/reporte/listadoAnalisis.jasper";
				data = new JRBeanCollectionDataSource(rep.getlDetalle());
				
			} else if(txt_accion.equals("repHojTra")){
				/***FALTA ***/
